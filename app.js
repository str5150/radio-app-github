            ...
            <div class="episode-content">
                ...
                <div class="episode-meta">
                 ...
                 <div class="episode-actions">
                    <button class="like-btn" data-episode-id="${episode.id}">❤️ <span class="like-count">${episode.likes || 0}</span></button>
                    <button class="comment-btn" data-episode-id="${episode.id}">💬 <span class="comment-count">${episode.comments?.length || 0}</span></button>
                </div>
            </div>`;
